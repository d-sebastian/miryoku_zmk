...
U_NP,              U_NP,              &kp LSHIFT,        &u_to_U_SYM,       &kp RET,           &kp LCTRL,         &kp SPACE,         &u_to_U_NAV,             U_NP,              U_NP
...
U_NP,              U_NP,              &kp LSHIFT,        &u_to_U_SYM,       &kp RET,           &kp TAB,           &kp ESC,           &kp LALT,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_NA,              &kp SPACE,         &u_to_U_NAV,             U_NP,              U_NP
