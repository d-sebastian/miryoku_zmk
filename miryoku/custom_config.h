...
U_NP,              U_NP,              &kp LSHIFT,        &mo U_SYM,         U_MT(LCTRL, RET),  &kp BSPC,          &kp SPACE,         U_LT(U_NAV, TAB),  U_NP,              U_NP
...
&kp N6,            &kp N7,            &kp N8,            &kp N9,            &kp N0,            &kp UNDER,         &kp PLUS,          &kp LBRC,          &kp RBRC,          &kp DQT,           \
U_NP,              U_NP,              &kp LSHIFT,        &mo U_SYM,         &kp RET,           &kp LGUI,          &kp ESC,           &kp LALT,              U_NP,              U_NP
